...
function SignUp({ providers }) {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>iReviewer - Reviewers For All</title>
        <meta
          name="description"
          content="Sign up and get access to reviewers!"
        />
            ...
            <>
              ...
              >
                <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                  ...
                  <Text color={"gray.500"}>
                    iReviewer is a platform where students can freely share
                    their reviewers online with ease. Download and upload
                    through the cloud.
                  </Text>
                  <Stack
                    spacing={{ base: 4, sm: 6 }}
